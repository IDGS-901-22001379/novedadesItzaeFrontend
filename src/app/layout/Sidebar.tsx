...
/*
  Tokens por tema del Sidebar.
  dark: sidebar oscuro y selección azul
  light: sidebar claro y selección verde
  blue/green/candy: sidebar a color completo
*/
function themeTokens(t: SidebarTheme) {
  if (t === "dark") {
    return {
      isDark: true,
      shell: "bg-gradient-to-b from-[#111215] via-[#14161a] to-[#0b0c0f] text-white border-white/10",
  ...
  if (t === "blue") {
    return {
      isDark: true,
      shell: "bg-gradient-to-b from-[#4fb2ff] via-[#2a92e6] to-[#176fbd] text-white border-white/15",
  ...
  if (t === "green") {
    return {
      isDark: false,
      shell: "bg-gradient-to-b from-[#8df2a6] via-[#6eea8e] to-[#35d874] text-slate-900 border-black/10",
  ...
  return {
    isDark: true,
    shell: "bg-gradient-to-b from-[#ff4fb0] via-[#bd13ec] to-[#7a12b5] text-white border-white/20",
    hover: "hover:bg-white/10",
    muted: "text-white/80",
  ...
  return (
    ...
    >
      <div className="px-4 pt-4 pb-3">
        <div className="flex items-center justify-between relative">
          <div className="flex items-center gap-3 min-w-0">
            <div
              className={["h-14 w-14 rounded-full overflow-hidden ring-2 shrink-0", ui.divider].join(" ")}
              title="Logo"
            >
            ...
            {!collapsed && (
              <div className="min-w-0">
                ...
                <div className={["mt-2 flex items-center gap-2", ui.muted].join(" ")}>
                  <Dot
                    title="Tema oscuro"
          ...
          <button
            ...
            className={[
              ...
              collapsed
                ? ["absolute left-4 top-4 h-14 w-14", "bg-transparent hover:bg-transparent", "z-50"].join(" ")
                : ["h-11 w-11", ui.hover].join(" "),
            ].join(" ")}
            title={collapsed ? "Expandir" : "Colapsar"}
          >
            {collapsed ? <ChevronsRight size={22} className="opacity-0" /> : <ChevronsLeft size={22} />}
          </button>
        </div>
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    [
                      ...
                      isActive ? ["ring-2", ui.ring, ui.active].join(" ") : ui.hover,
      ...
      <div className={["border-t", ui.divider].join(" ")}>
        <div className={["px-4 py-3 flex items-center gap-3", footerBg].join(" ")}>
          <NavLink
            to="/perfil"
            className={[
          ...
          {!collapsed && (
            <NavLink to="/perfil" className="flex-1 leading-4 min-w-0" title="Perfil">

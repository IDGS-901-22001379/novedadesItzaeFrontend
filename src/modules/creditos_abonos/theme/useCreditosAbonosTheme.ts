// src/modules/creditos_abonos/theme/useCreditosAbonosTheme.ts
// Hook del tema de Créditos Abonos.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import {
  getCreditosAbonosThemeFromContentBg,
  type ContentBg,
} from "./creditosAbonosTheme";
...
export function useCreditosAbonosTheme() {
  ...
  return getCreditosAbonosThemeFromContentBg(contentBg);
}
// src/modules/creditos_abonos/theme/creditosAbonosTheme.ts
// Tema visual del módulo Créditos Abonos.
...
export type CreditosAbonosTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, CreditosAbonosTheme> = {
  light: {
...
export function getCreditosAbonosThemeFromContentBg(
  contentBg: ContentBg
): CreditosAbonosTheme {

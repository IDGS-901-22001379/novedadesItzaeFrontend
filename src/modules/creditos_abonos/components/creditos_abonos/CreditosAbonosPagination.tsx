// src/modules/creditos_abonos/components/creditos_abonos/CreditosAbonosPagination.tsx
// Paginación del listado de Créditos Abonos.
...
export default function CreditosAbonosPagination({
  theme,
  page,
  totalPages,
  from,

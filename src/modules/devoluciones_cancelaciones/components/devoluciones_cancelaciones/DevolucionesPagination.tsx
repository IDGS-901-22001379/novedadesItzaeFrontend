// src/modules/devoluciones_cancelaciones/components/devoluciones_cancelaciones/DevolucionesPagination.tsx
// Paginación del listado de Devoluciones/Cancelaciones.
...
export default function DevolucionesPagination({
  theme,
  page,
  totalPages,
  from,

// src/modules/devoluciones_cancelaciones/theme/useDevolucionesCancelacionesTheme.ts
// Hook del tema de Devoluciones/Cancelaciones.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import {
  getDevolucionesCancelacionesThemeFromContentBg,
  type ContentBg,
} from "./devolucionesCancelacionesTheme";
...
export function useDevolucionesCancelacionesTheme() {
  ...
  return getDevolucionesCancelacionesThemeFromContentBg(contentBg);
}
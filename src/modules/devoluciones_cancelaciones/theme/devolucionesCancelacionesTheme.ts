// src/modules/devoluciones_cancelaciones/theme/devolucionesCancelacionesTheme.ts
// Tema visual del módulo Devoluciones/Cancelaciones.
...
export type DevolucionesCancelacionesTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, DevolucionesCancelacionesTheme> = {
  light: {
...
export function getDevolucionesCancelacionesThemeFromContentBg(
  contentBg: ContentBg
): DevolucionesCancelacionesTheme {

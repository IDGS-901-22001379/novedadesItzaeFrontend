// src/modules/proveedores_productos/theme/proveedores_productosTheme.ts
// Tema visual del módulo Proveedores-Productos.
...
export type Proveedores_productosTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, Proveedores_productosTheme> = {
  light: {
...
export function getProveedores_productosThemeFromContentBg(
  contentBg: ContentBg,
): Proveedores_productosTheme {

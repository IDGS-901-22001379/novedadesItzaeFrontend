// src/modules/proveedores_productos/theme/useProveedores_productosTheme.ts
// Hook del tema de Proveedores-Productos.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import {
  getProveedores_productosThemeFromContentBg,
  type ContentBg,
} from "./proveedores_productosTheme";
...
export function useProveedores_productosTheme() {
  ...
  return getProveedores_productosThemeFromContentBg(contentBg);
}
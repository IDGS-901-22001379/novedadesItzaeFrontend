// src/modules/proveedores_productos/components/proveedores_productos/Proveedores_productosHeader.tsx
// Encabezado de la pantalla Proveedores-Productos.
// Responsabilidades: título, resumen centrado y botón principal (nueva relación).
...
export default function Proveedores_productosHeader({
  resumen,
  loading,
  onNuevo,
}: Props) {

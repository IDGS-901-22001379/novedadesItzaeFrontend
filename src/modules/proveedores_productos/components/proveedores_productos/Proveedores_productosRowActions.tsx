// src/modules/proveedores_productos/components/proveedores_productos/Proveedores_productosRowActions.tsx
// Acciones por fila en la tabla de Proveedores-Productos.
...
type Props = {
  item: ProveedorProductoRow;
  onVer: (item: ProveedorProductoRow) => void;
  onEditar: (item: ProveedorProductoRow) => void;
  onEliminar: (item: ProveedorProductoRow) => void; // mantiene el mismo handler
};

export default function Proveedores_productosRowActions({
  item,
  onVer,
  onEditar,
  onEliminar,

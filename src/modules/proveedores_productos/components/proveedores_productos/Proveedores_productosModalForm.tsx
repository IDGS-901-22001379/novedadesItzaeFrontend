// src/modules/proveedores_productos/components/proveedores_productos/Proveedores_productosModalForm.tsx
// Modal contenedor para formularios del módulo Proveedores-Productos.
...
export default function Proveedores_productosModalForm({
  open,
  title,
  theme,
  onClose,

// src/modules/proveedores_productos/components/proveedores_productos/Proveedores_productosPagination.tsx
// Paginación del listado de Proveedores-Productos.
...
export default function Proveedores_productosPagination({
  theme,
  page,
  totalPages,
  from,

// src/modules/movimientos_inventario/theme/useMovimientosInventarioTheme.ts
// Hook del tema de Movimientos de Inventario.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import {
  getMovimientosInventarioThemeFromContentBg,
  type ContentBg,
} from "./movimientosInventarioTheme";
...
export function useMovimientosInventarioTheme() {
  ...
  return getMovimientosInventarioThemeFromContentBg(contentBg);
}
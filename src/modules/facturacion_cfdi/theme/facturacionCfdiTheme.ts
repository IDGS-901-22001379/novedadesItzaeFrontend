// src/modules/facturacion_cfdi/theme/facturacionCfdiTheme.ts
// Tema visual del módulo Facturación CFDI.
// Responsabilidades: traducir el content_bg del Topbar a clases Tailwind y colores consistentes.
// Nota: los colores del módulo conservan la misma base visual global para mantener uniformidad.
...
export type FacturacionCfdiTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, FacturacionCfdiTheme> = {
  light: {
...
export function getFacturacionCfdiThemeFromContentBg(
  contentBg: ContentBg
): FacturacionCfdiTheme {

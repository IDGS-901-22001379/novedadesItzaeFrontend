// src/modules/facturacion_cfdi/theme/useFacturacionCfdiTheme.ts
// Hook del tema de Facturación CFDI.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import {
  getFacturacionCfdiThemeFromContentBg,
  type ContentBg,
} from "./facturacionCfdiTheme";
...
export function useFacturacionCfdiTheme() {
  ...
  return getFacturacionCfdiThemeFromContentBg(contentBg);
}
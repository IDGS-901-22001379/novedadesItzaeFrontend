// src/modules/facturacion_cfdi/components/facturacion_cfdi/FacturacionCfdiPagination.tsx
// Paginación del listado de Facturación CFDI.
...
export default function FacturacionCfdiPagination({
  theme,
  page,
  totalPages,
  from,

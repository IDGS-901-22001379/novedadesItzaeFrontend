// src/modules/facturacion_cfdi/components/facturacion_cfdi/FacturacionCfdiAlert.tsx
// Alertas del módulo Facturación CFDI.
...
export default function FacturacionCfdiAlert({ type, message }: Props) {

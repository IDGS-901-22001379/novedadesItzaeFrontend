// src/modules/usuarios/components/usuarios/UsuariosRowActions.tsx
// Acciones por fila en la tabla de Usuarios.
...
type Props = {
  ...
  onEliminar: (u: User) => void; // mantiene el mismo handler
};

export default function UsuariosRowActions({
  user,
  onVer,
  onEditar,
  onEliminar,
}: Props) {
  const isInactivo = user.estatus === "INACTIVO";

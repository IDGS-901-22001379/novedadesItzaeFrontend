// src/modules/usuarios/components/usuarios/UsuariosPagination.tsx
...
export default function UsuariosPagination({ theme, page, totalPages, from, to, total, onPrev, onNext }: Props) {
  return (
    <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
      <div className="text-sm font-semibold text-black/70">
        Mostrando <span className="font-extrabold">{from}</span> a <span className="font-extrabold">{to}</span> de{" "}

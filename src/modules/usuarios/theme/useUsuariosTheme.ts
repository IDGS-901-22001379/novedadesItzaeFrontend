// src/modules/usuarios/theme/useUsuariosTheme.ts
// Hook del tema de Usuarios.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import { getUsuariosThemeFromContentBg, type ContentBg } from "./usuariosTheme";
...
export function useUsuariosTheme() {
  ...
  return getUsuariosThemeFromContentBg(contentBg);
}
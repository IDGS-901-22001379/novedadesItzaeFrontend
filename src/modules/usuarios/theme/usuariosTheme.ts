// src/modules/usuarios/theme/usuariosTheme.ts
// Tema visual del módulo Usuarios.
...
const THEMES: Record<ContentBg, UsuariosTheme> = {
  light: {
...
export function getUsuariosThemeFromContentBg(contentBg: ContentBg): UsuariosTheme {

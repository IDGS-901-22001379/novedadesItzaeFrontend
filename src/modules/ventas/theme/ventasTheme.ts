// src/modules/ventas/theme/ventasTheme.ts
// Tema visual del módulo Ventas.
// Responsabilidades:
// - Traducir el content_bg del Topbar a clases Tailwind.
// - Mantener consistencia visual con los módulos Usuarios y Productos.
// - Permitir que Ventas cambie automáticamente cuando el usuario
//   cambia el fondo general desde Topbar.
//
// Nota:
// Los colores se dejaron exactamente iguales a Usuarios y Productos para que
// todos los módulos compartan la misma identidad visual.

export type ContentBg = "light" | "dark" | "blue" | "green" | "candy";

export type VentasTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, VentasTheme> = {
  light: {
...
export function getVentasThemeFromContentBg(contentBg: ContentBg): VentasTheme {

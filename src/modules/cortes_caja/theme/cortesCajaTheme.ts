// src/modules/cortes_caja/theme/cortesCajaTheme.ts
// Tema visual del módulo Cortes de Caja.
// Se encarga de traducir el content_bg del Topbar a clases Tailwind, conservando exactamente los mismos colores del módulo Usuarios.

export type ContentBg = "light" | "dark" | "blue" | "green" | "candy";

export type CortesCajaTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, CortesCajaTheme> = {
  light: {
...
// Devuelve el tema visual correspondiente al fondo seleccionado en el Topbar.
export function getCortesCajaThemeFromContentBg(contentBg: ContentBg): CortesCajaTheme {

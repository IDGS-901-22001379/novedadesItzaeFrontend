// src/modules/caja/theme/cajaTheme.ts
// Tema visual del módulo Caja.
// Responsabilidades: traducir el content_bg del Topbar a clases Tailwind y colores consistentes.
// Nota: conserva exactamente la misma lógica visual usada en Usuarios para mantener uniformidad entre módulos.

export type ContentBg = "light" | "dark" | "blue" | "green" | "candy";

export type CajaTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, CajaTheme> = {
  light: {
...
// Obtiene el tema visual del módulo Caja con base en el color global seleccionado.
export function getCajaThemeFromContentBg(contentBg: ContentBg): CajaTheme {

// src/modules/caja/components/caja/CajaPagination.tsx
// Paginación del listado de Cajas.
// Responsabilidades: navegar páginas y mostrar el rango actual de registros visibles.
...
export default function CajaPagination({
  theme,
  page,
  totalPages,
  from,

// src/modules/traspasos/theme/traspasosTheme.ts
// Tema visual del módulo Traspasos.
// Responsabilidades: traducir el content_bg del Topbar a clases Tailwind y colores consistentes.
// Nota: se conserva exactamente la misma paleta y estructura visual del módulo Usuarios.

export type ContentBg = "light" | "dark" | "blue" | "green" | "candy";

export type TraspasosTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, TraspasosTheme> = {
  light: {
...
export function getTraspasosThemeFromContentBg(contentBg: ContentBg): TraspasosTheme {

// src/modules/clientes/theme/clientesTheme.ts
// Tema visual del módulo Clientes.
...
const THEMES: Record<ContentBg, ClientesTheme> = {
  light: {
...
export function getClientesThemeFromContentBg(contentBg: ContentBg): ClientesTheme {

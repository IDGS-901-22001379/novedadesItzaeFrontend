// src/modules/inventario_ubicaciones/components/inventario_ubicaciones/InventarioUbicacionesModalForm.tsx
// Modal contenedor para formularios del módulo Inventario - Ubicaciones.
...
export default function InventarioUbicacionesModalForm({
  open,
  title,
  theme,
  onClose,

// src/modules/inventario_ubicaciones/components/inventario_ubicaciones/InventarioUbicacionesRowActions.tsx
// Acciones por fila en la tabla de Inventario - Ubicaciones.

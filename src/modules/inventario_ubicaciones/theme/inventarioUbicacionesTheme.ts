// src/modules/inventario_ubicaciones/theme/inventarioUbicacionesTheme.ts
// Tema visual del módulo Inventario - Ubicaciones.
...
export type InventarioUbicacionesTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, InventarioUbicacionesTheme> = {
  light: {
...
export function getInventarioUbicacionesThemeFromContentBg(
  contentBg: ContentBg
): InventarioUbicacionesTheme {

// src/modules/inventario_ubicaciones/theme/useInventarioUbicacionesTheme.ts
// Hook del tema de Inventario - Ubicaciones.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import {
  getInventarioUbicacionesThemeFromContentBg,
  type ContentBg,
} from "./inventarioUbicacionesTheme";
...
export function useInventarioUbicacionesTheme() {
  ...
  return getInventarioUbicacionesThemeFromContentBg(contentBg);
}
// src/modules/creditos/theme/useCreditosTheme.ts
// Hook del tema de Créditos y Cobranza - Créditos.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import { getCreditosThemeFromContentBg, type ContentBg } from "./creditosTheme";
...
export function useCreditosTheme() {
  ...
  return getCreditosThemeFromContentBg(contentBg);
}
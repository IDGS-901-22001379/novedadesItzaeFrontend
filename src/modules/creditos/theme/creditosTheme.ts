// src/modules/creditos/theme/creditosTheme.ts
// Tema visual del módulo Créditos y Cobranza - Créditos.
// Responsabilidades: traducir el content_bg del Topbar a clases Tailwind y colores consistentes.
// Nota: se reutilizan los mismos colores base del módulo Usuarios para mantener uniformidad visual.
...
const THEMES: Record<ContentBg, CreditosTheme> = {
  light: {
...
export function getCreditosThemeFromContentBg(contentBg: ContentBg): CreditosTheme {

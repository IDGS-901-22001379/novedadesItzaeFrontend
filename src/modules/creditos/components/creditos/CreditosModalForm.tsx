// src/modules/creditos/components/creditos/CreditosModalForm.tsx
// Modal contenedor para formularios del módulo Créditos.
...
export default function CreditosModalForm({
  open,
  title,
  theme,
  onClose,

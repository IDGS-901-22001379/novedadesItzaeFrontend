// src/modules/clientes_fiscales/theme/useClientesFiscalesTheme.ts
// Hook del tema de Clientes Fiscales.
// MISMO que Usuarios: lee content_bg desde Topbar (localStorage) y escucha cambios por evento.

import { useEffect, useState } from "react";
import { getClientesFiscalesThemeFromContentBg, type ContentBg } from "./clientesFiscalesTheme";
...
export function useClientesFiscalesTheme() {
  ...
  return getClientesFiscalesThemeFromContentBg(contentBg);
}
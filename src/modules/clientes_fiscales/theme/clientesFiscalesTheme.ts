// src/modules/clientes_fiscales/theme/clientesFiscalesTheme.ts
// Tema visual del módulo Clientes Fiscales.
// MISMO comportamiento y clases que Usuarios (se refleja lo del Topbar content_bg).

export type ContentBg = "light" | "dark" | "blue" | "green" | "candy";

export type ClientesFiscalesTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, ClientesFiscalesTheme> = {
  light: {
...
export function getClientesFiscalesThemeFromContentBg(contentBg: ContentBg): ClientesFiscalesTheme {

// src/modules/proveedores/components/proveedores/ProveedoresHeader.tsx
// Encabezado de la pantalla Proveedores.
// Responsabilidades: título, resumen centrado y botón principal (nuevo proveedor).
...
export default function ProveedoresHeader({
  resumen,
  loading,
  onNuevo,
}: Props) {

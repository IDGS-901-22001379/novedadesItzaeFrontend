// src/modules/proveedores/components/proveedores/ProveedoresAlert.tsx
// Alertas del módulo Proveedores.
...
export default function ProveedoresAlert({ type, message }: Props) {

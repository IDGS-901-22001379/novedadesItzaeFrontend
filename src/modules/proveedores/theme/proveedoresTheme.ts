// src/modules/proveedores/theme/proveedoresTheme.ts
// Tema visual del módulo Proveedores.
...
const THEMES: Record<ContentBg, ProveedoresTheme> = {
  light: {
...
export function getProveedoresThemeFromContentBg(contentBg: ContentBg): ProveedoresTheme {

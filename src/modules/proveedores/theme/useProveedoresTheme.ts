// src/modules/proveedores/theme/useProveedoresTheme.ts
// Hook del tema de Proveedores.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import { getProveedoresThemeFromContentBg, type ContentBg } from "./proveedoresTheme";
...
export function useProveedoresTheme() {
  ...
  return getProveedoresThemeFromContentBg(contentBg);
}
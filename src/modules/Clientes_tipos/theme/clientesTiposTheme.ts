// src/modules/clientes_tipos/theme/clientesTiposTheme.ts
// Tema visual del módulo Clientes Tipos.
...
export type ClientesTiposTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, ClientesTiposTheme> = {
  light: {
...
export function getClientesTiposThemeFromContentBg(contentBg: ContentBg): ClientesTiposTheme {

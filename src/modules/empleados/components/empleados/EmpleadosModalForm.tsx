// src/modules/empleados/components/empleados/EmpleadosModalForm.tsx
// Modal contenedor para formularios del módulo Empleados.
...
export default function EmpleadosModalForm({
  open,
  title,
  theme,
  onClose,

// src/modules/inventario_sucursales/components/inventario_sucursales/InventarioSucursalesPagination.tsx
// Paginación del listado de Inventario - Sucursales.
...
export default function InventarioSucursalesPagination({
  theme,
  page,
  totalPages,
  from,

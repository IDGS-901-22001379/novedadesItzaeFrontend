// src/modules/inventario_sucursales/theme/useInventarioSucursalesTheme.ts
// Hook del tema de Inventario - Sucursales.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import {
  getInventarioSucursalesThemeFromContentBg,
  type ContentBg,
} from "./inventarioSucursalesTheme";
...
export function useInventarioSucursalesTheme() {
  ...
  return getInventarioSucursalesThemeFromContentBg(contentBg);
}
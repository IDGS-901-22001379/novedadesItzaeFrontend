// src/modules/inventario_sucursales/theme/inventarioSucursalesTheme.ts
// Tema visual del módulo Inventario - Sucursales.
// Responsabilidades: traducir el content_bg del Topbar a clases Tailwind y colores consistentes.
// Nota: mantiene el mismo comportamiento visual que Usuarios para que todo el sistema cambie junto.

export type ContentBg = "light" | "dark" | "blue" | "green" | "candy";

export type InventarioSucursalesTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, InventarioSucursalesTheme> = {
  light: {
...
export function getInventarioSucursalesThemeFromContentBg(
  contentBg: ContentBg,
): InventarioSucursalesTheme {

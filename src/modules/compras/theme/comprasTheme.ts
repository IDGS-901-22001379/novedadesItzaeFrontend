// src/modules/compras/theme/comprasTheme.ts
// Tema visual del módulo Compras.
// Responsabilidades: traducir el content_bg del Topbar a clases Tailwind y colores consistentes.
// Nota: los colores del módulo son los mismos que Usuarios para mantener consistencia visual.

export type ContentBg = "light" | "dark" | "blue" | "green" | "candy";

export type ComprasTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, ComprasTheme> = {
  light: {
...
export function getComprasThemeFromContentBg(contentBg: ContentBg): ComprasTheme {

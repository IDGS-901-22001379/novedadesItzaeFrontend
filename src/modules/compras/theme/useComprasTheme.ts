// src/modules/compras/theme/useComprasTheme.ts
// Hook del tema de Compras.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import { getComprasThemeFromContentBg, type ContentBg } from "./comprasTheme";
...
export function useComprasTheme() {
  ...
  return getComprasThemeFromContentBg(contentBg);
}
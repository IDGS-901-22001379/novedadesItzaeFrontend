// src/modules/productos/theme/productosTheme.ts
// Tema visual del módulo Productos.
// Responsabilidades:
// - Traducir el content_bg del Topbar a clases Tailwind.
// - Mantener consistencia visual con el módulo Usuarios.
// - Permitir que Productos cambie automáticamente cuando el usuario
//   cambia el fondo general desde Topbar.
//
// Nota:
// Los colores se dejaron exactamente iguales a Usuarios para que
// ambos módulos compartan la misma identidad visual.

export type ContentBg = "light" | "dark" | "blue" | "green" | "candy";

export type ProductosTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, ProductosTheme> = {
  light: {
...
// Regresa el tema visual correspondiente al fondo actual.
export function getProductosThemeFromContentBg(contentBg: ContentBg): ProductosTheme {

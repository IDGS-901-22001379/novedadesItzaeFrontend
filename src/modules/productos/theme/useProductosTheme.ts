// src/modules/productos/theme/useProductosTheme.ts
// Hook del tema de Productos.
// Responsabilidades:
// - Leer el content_bg definido desde Topbar en localStorage.
// - Escuchar cambios del tema en tiempo real.
// - Regresar el theme visual del módulo Productos.
//
// Nota:
// Este módulo usa exactamente la misma lógica visual que Usuarios,
// para mantener consistencia total en colores y comportamiento.

import { useEffect, useState } from "react";
import { getProductosThemeFromContentBg, type ContentBg } from "./productosTheme";
...
export function useProductosTheme() {
  ...
  return getProductosThemeFromContentBg(contentBg);
}
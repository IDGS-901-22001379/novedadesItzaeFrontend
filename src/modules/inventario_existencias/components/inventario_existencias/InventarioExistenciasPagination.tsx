// src/modules/inventario_existencias/components/inventario_existencias/InventarioExistenciasPagination.tsx
// Paginación del listado de Inventario Existencias.
...
export default function InventarioExistenciasPagination({
  theme,
  page,
  totalPages,
  from,

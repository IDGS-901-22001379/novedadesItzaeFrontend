// src/modules/inventario_existencias/theme/inventarioExistenciasTheme.ts
// Tema visual del módulo Inventario Existencias.
...
export type InventarioExistenciasTheme = {
  titleText: string;
...
const THEMES: Record<ContentBg, InventarioExistenciasTheme> = {
  light: {
...
export function getInventarioExistenciasThemeFromContentBg(
  contentBg: ContentBg,
): InventarioExistenciasTheme {

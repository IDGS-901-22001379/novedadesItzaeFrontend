// src/modules/inventario_existencias/theme/useInventarioExistenciasTheme.ts
// Hook del tema de Inventario Existencias.
// Responsabilidades: leer el content_bg desde Topbar (localStorage) y escuchar cambios por evento.

import { useEffect, useState } from "react";
import {
  getInventarioExistenciasThemeFromContentBg,
  type ContentBg,
} from "./inventarioExistenciasTheme";
...
export function useInventarioExistenciasTheme() {
  ...
  return getInventarioExistenciasThemeFromContentBg(contentBg);
}